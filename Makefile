...
TEST_MAIN = test_main_loop.bin
TEST_IMAGE = test_image_parser.bin
...
SOURCES = test_main_loop.c car.c scene.c pedal.c adc.c i2c.c parseImage.c test_image_parser.c obstacles.c
